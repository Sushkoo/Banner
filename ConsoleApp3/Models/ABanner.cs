...
namespace ConsoleApp3.Models
{
    public abstract class ABanner
    {
        ...
        {
            if (rowNum<MIN_ROWNUM || rowNum>MAX_ROWNUM || columnNum>MAX_COLUMNNUM || columnNum<MIN_COLUMNNUM)
            {
        ...
        {
            get {
                if (rowIndex < MIN_ROWNUM || rowIndex > MAX_ROWNUM || colIndex > MAX_COLUMNNUM || colIndex < MIN_COLUMNNUM)
                    throw new ArgumentException("Nem megengedett argumentum!");
